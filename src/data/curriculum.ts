    ...
    chapters: [
      {
        ...
        units: [
          ...
          { id: '1-1-u6', title: '6. 공약수와 최대공약수', status: 'unlocked', path: '/1-1-u6' },
          { id: '1-1-u7', title: '7. 공배수와 최소공배수', status: 'unlocked', path: '/1-1-u7' },
          { id: '1-1-u8', title: '8. 최대공약수와 최소공배수의 관계', status: 'unlocked', path: '/1-1-u8' }
        ]
      },
      {
        id: '1-1-ch2',
